...
function Cards(props) {
  ...
  const handleFavorite = (character) => {
    if (favoritelist.includes(character.id) === false) {
      console.log(
        "el favorite que llega a la funcion antes del dispatch",
        character
      );
...
*/
  console.log("valor de favoritelist", favoritelist);
  return (
    //
...
const mapDispatchToprops = {
  // este objecto es quien envia las funciones de las actions como props a mi componente para luego usarlas en onClick()
  addFav,
  removeFav,
};
